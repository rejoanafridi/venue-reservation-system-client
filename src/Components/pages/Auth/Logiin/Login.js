...
const LoggIn = () => {
  ...
  const saveUser = (email, displayName, method) => {
    ...
    fetch("https://stark-refuge-22237.herokuapp.com/users", {
      method: method,
      headers: {
  ...
  return (
    <div className="w-25 mx-auto my-5">
      <h2 className="text-warning text-center bg-dark eounded opacity-75">{registerd ? "Login" : "Signin"} Page</h2>
      ...
      <Form onSubmit={handleReload}>
        ...
        <button
          ...
          type="button"
          className="mt-4 btn btn-warning fw-bold align-items-center text-center"
        >
