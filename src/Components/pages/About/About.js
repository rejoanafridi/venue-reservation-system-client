...
const About = () => {
	return (
		<section className=" my-3" id="aboutus">
			<h1 className="text-center fw-bold bg-light">About Us</h1>
				...
				<div className="container p-4">
					<div className="row gx-5">
						...
						<div className="col-lg-6 p-3">
							...
							<p className="fw-light text-dark text-center bg-light rounded p-1">
								Being established in 2002, Daffodil International University has
								become a prominent private university in Bangladesh. Our 150
								Acre campus is full of life and positive energy, fostering
								education and innovation for more than 20000 students. Here,
								students are encouraged to ask questions and think, debate and
								collaborate with professors to take ownership of their learning.
